...
| Java (JDK) | 11 |
| MySQL Server | 8.0 |
| MySQL Connector/J | 8.x (`mysql-connector-java-8.x.x.jar`) |
| IDE (opcional) | Eclipse / IntelliJ IDEA |
...
| Aba | Conteúdo |
|---|---|
| **Dados Pessoais** | RGM, nome, data de nascimento, CPF, e-mail, endereço, UF, celular |
| **Curso** | Seleção de curso, campus e período (Matutino/Vespertino/Noturno) |
| **Notas e Faltas** | Disciplina, semestre, nota e faltas — tabela com histórico do aluno |
| **Boletim** | Resumo por disciplina com situação final colorida por aprovação |
